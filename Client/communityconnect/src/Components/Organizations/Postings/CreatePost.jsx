...
const CreatePost = ({ onCreatePost }) => {
    ...
    const [imageUploaded, setImageUploaded] = useState(false); // Track if image upload is completed
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const postWithComments = { ...formData, comments: [] };
                ...
                <div className="modal-container fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
                    <div className="modal-box bg-white p-8 rounded-lg shadow-lg">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button type="submit" className={`btn bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 ${!imageUploaded ? 'disabled' : ''}`} disabled={!imageUploaded}>Create Post</button>
                        </form>
                    </div>
                </div>
            )}
