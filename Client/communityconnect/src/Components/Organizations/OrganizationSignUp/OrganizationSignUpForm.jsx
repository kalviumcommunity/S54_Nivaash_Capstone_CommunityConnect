  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://communityserver.vercel.app/organisations/createorganisation",
        formData
      );
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-white">
      ...
      <div>
        <form
          ...
          className="bg-[#111827] p-20 br rounded-lg text-white"
        >
          <h1 className="text-3xl mb-10">Register Now</h1>
            ...
            <div>
              ...
              <div className="flex">
                <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                  <svg
                    className="w-4 h-4 text-black-800 dark:text-gray-400"
                    aria-hidden="true"
          ...
          <div className="mb-6">
            ...
            <div className="flex">
              ...
              <input
                ...
                className="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full ps-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Enter the Organization mail"
              />
            </div>
          </div>
          <div className="mb-6">
