...
function SignUp() {
  ...
  return (
    <>
      <NavBar />
      <div className="h-screen flex flex-col items-center justify-center bg-gray-100 overflow-y-hidden"> 
        <div className="w-screen h-full flex items-center justify-center">
          ...
          <div className="w-1/2 p-10 h-full flex flex-col items-center shadow-md" style={{ boxShadow: "-5px 0px 5px 0px rgba(0,0,0,0.5)" }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center space-y-6 w-full max-w-md">
              ...
              <div className="mb-4 flex justify-center items-center">
                ...
                <input 
                  ...
                  className={`w-80 px-4 py-2 border rounded-md border-black focus:outline-none focus:border-blue-500 bg-white text-black ${errors.password && 'border-red-500'}`} 
                />
              </div>
              ...
              <div className="mb-4 flex justify-center items-center">
                ...
                <input 
                  ...
                  className={`w-80 px-4 py-2 border border-black rounded-md focus:outline-none focus:border-blue-500 bg-white text-black ${errors.repeatPassword && 'border-red-500'}`} 
                />
              </div>
