      ...
      <div className="flex h-full items-center justify-center bg-white">
        <div className="flex flex-col items-center w-full h-full">
          <div className="bg-white py-0 flex flex-col justify-center items-center w-full h-100 md:flex-row">
            <div style={{boxShadow:"5px 0px 10px 0px rgba(0,0,0,0.8)"}} className="flex flex-col justify-center py-20  items-center w-full h-full md:w-1/2 px-0 shadow-md">
              <h1 className="text-black text-xl md:text-2xl mb-12">Sign Up</h1>
              {!isAuthenticated && (
                <form className="flex flex-col items-center space-y-9 w-full h-full">
